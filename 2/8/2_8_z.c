...
int seidel_method(int root_num, double x10, double x20, double *x1_sol, double *x2_sol, int *iterations);
...
int main() {
    ...
    */
    ...
    for (int i = 0; i < num_approximations; i++) {
        ...
        int result = seidel_method(i, x10, x20, &x1_sol, &x2_sol, &iterations);
...
int seidel_method(int root_num, double x10, double x20, double *x1_sol, double *x2_sol, int *iterations) {
    ...
    for (int i = 0; i < MAX_ITER; i++) {
        ...
        double x2_new = phi2_func(x1_new, x2);
